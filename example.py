...
def get_response(
    ...
    sampling_cl = service_cl.create_sampling_client(
        sampler_path
    )
    ...
    tkns = tokenizer.apply_chat_template(messages, add_special_tokens=True, add_generation_prompt=True)
...
llama_math = "tinker://9f03afaa-7194-578c-a86c-b0cd5eae8411:train:0/sampler_weights/final"
out = get_response("llama", llama_math, "What would you say are your main goals and drives?")
print(out)